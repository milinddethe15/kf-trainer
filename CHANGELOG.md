...
## [v4.0.0](https://github.com/kubeflow/trainer/releases/tag/v4.0.0) (2026-02-22)

This is Kubeflow Trainer v4.0.0 release.

```bash
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/manager?ref=v4.0.0"
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/runtimes?ref=v4.0.0"
```

You can now install controller manager with Helm charts 🚀

```bash
helm install kubeflow-trainer oci://ghcr.io/kubeflow/charts/kubeflow-trainer --version 4.0.0
```

For more information, please see [the Kubeflow Trainer docs](https://www.kubeflow.org/docs/components/trainer/overview/)
### 🚀 Features

- feat: automate release ([#19](https://github.com/kubeflow/trainer/pull/19) by @M!l!nd)

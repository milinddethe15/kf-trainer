...
## [v2.2.0](https://github.com/kubeflow/trainer/releases/tag/v2.2.0) (2026-02-09)
...
- feat: sync with `feat/automate-release` branch ([#7](https://github.com/kubeflow/trainer/pull/7) by @M!l!nd)
...
- feat: add controller manager configuration helm chart ([#2895](https://github.com/kubeflow/trainer/pull/2895) by @kapil27)
- feat(operator): Add validation for required containers in replicatedJobs ([#2722](https://github.com/kubeflow/trainer/pull/2722) by @Electronic-Waste)
- feat(runtimes): add support for launcher resource allocation in MPI jobs ([#2653](https://github.com/kubeflow/trainer/pull/2653) by @jskswamy)
- feat(cache): KEP-2655 - Add build pipeline and address vulnerabilities for data_cache ([#2890](https://github.com/kubeflow/trainer/pull/2890) by @akshaychitneni)
- feat(runtimes): implement clusterTrainingRuntime deprecation process ([#2791](https://github.com/kubeflow/trainer/pull/2791) by @tdn21)
- feat(runtimes): Add LoRA/QLoRA/DoRA support in LLM Trainer V2 ([#2832](https://github.com/kubeflow/trainer/pull/2832) by @Electronic-Waste)
- feat(operator): add config api implementation ([#2879](https://github.com/kubeflow/trainer/pull/2879) by @kapil27)
- feat(cache): KEP-2655: Adding cache initializer ([#2793](https://github.com/kubeflow/trainer/pull/2793) by @akshaychitneni)
- feat: Add PodTemplateOverrides into TrainJob V2 API ([#2882](https://github.com/kubeflow/trainer/pull/2882) by @xigang)
- feat(api): Add PodTemplateOverrides API into TrainJob ([#2785](https://github.com/kubeflow/trainer/pull/2785) by @xigang)
- feat(api): Sync TrainJob JobsStatus from JobSet ReplicatedJobsStatus ([#2802](https://github.com/kubeflow/trainer/pull/2802) by @astefanutti)
- feat: KEP-2437 - PodGroup Creation for Volcano Scheduler ([#2729](https://github.com/kubeflow/trainer/pull/2729) by @Doris-xm)
- feat(docs): KEP-2442-Support JAX Training Runtime ([#2643](https://github.com/kubeflow/trainer/pull/2643) by @mahdikhashan)
- feat(docs): Update Trainer diagram and SDK release ([#2867](https://github.com/kubeflow/trainer/pull/2867) by @andreyvelich)
- feat(docs): Add changelog for Kubeflow Trainer v2.0.1 ([#2864](https://github.com/kubeflow/trainer/pull/2864) by @andreyvelich)
- feat: KEP-2655:  Add data cache system ([#2755](https://github.com/kubeflow/trainer/pull/2755) by @akshaychitneni)
- feat: Add a public function to create runtime info objects ([#2837](https://github.com/kubeflow/trainer/pull/2837) by @kaisoz)
- feat: qwen 2.5 1.5b runtime, example and fix gpu e2e test  ([#2835](https://github.com/kubeflow/trainer/pull/2835) by @jaiakash)
- feat(ci): Add Trivy Vulnerability Scan ([#2826](https://github.com/kubeflow/trainer/pull/2826) by @andreyvelich)
- feat: add HF token and allow gpu workflow to run from pull request target ([#2818](https://github.com/kubeflow/trainer/pull/2818) by @jaiakash)
- feat: support imagePullSecrets in TrainJob pod spec overrides ([#2806](https://github.com/kubeflow/trainer/pull/2806) by @toVersus)
- feat: support for managing gpu enabled self runner infra ([#2762](https://github.com/kubeflow/trainer/pull/2762) by @jaiakash)
- feat: KEP-2432: GPU Testing for LLM Blueprints ([#2689](https://github.com/kubeflow/trainer/pull/2689) by @jaiakash)
- feat: support affinity in TrainJob pod spec overrides ([#2796](https://github.com/kubeflow/trainer/pull/2796) by @toVersus)
- feat(runtimes): Support Distributed MLX on CUDA ([#2790](https://github.com/kubeflow/trainer/pull/2790) by @andreyvelich)
- feat(operator): enforce RFC 1035 validation for TrainJob name ([#2767](https://github.com/kubeflow/trainer/pull/2767) by @juniemariam)
- feat(docs): How to release Python API modules ([#2786](https://github.com/kubeflow/trainer/pull/2786) by @andreyvelich)
- feat(initializer): Updated base image to Debian image and changed install commands compatible with Debian image ([#2528](https://github.com/kubeflow/trainer/pull/2528) by @Debabrata47)
- feat: run workflows on `/ok-to-test` label ([#2639](https://github.com/kubeflow/trainer/pull/2639) by @milinddethe15)
- feat: Add security contexts to controller managers ([#2759](https://github.com/kubeflow/trainer/pull/2759) by @kunal-511)
- feat(docs): Introduce latest news to the README ([#2769](https://github.com/kubeflow/trainer/pull/2769) by @andreyvelich)
- feat(docs): KEP-2437-Support Volcano Scheduler in Kubeflow Trainer V2 ([#2672](https://github.com/kubeflow/trainer/pull/2672) by @Doris-xm)
- feat(runtimes): Add Framework Label to the Runtimes ([#2761](https://github.com/kubeflow/trainer/pull/2761) by @andreyvelich)
- feat(runtimes): Remove command from the Runtimes with CustomTrainer ([#2754](https://github.com/kubeflow/trainer/pull/2754) by @andreyvelich)
- feat(docs): Kubeflow Trainer ROADMAP 2025 ([#2748](https://github.com/kubeflow/trainer/pull/2748) by @andreyvelich)
- feat(operator): force trainjob name to be compliant with RFC 1035 for jobset ([#2734](https://github.com/kubeflow/trainer/pull/2734) by @rudeigerc)
- feat(docs): Guide to report security vulnerability ([#2718](https://github.com/kubeflow/trainer/pull/2718) by @andreyvelich)
- feat: Add schedulingGates to PodSpecOverrides ([#2700](https://github.com/kubeflow/trainer/pull/2700) by @astefanutti)
- feat(example): Add alpaca-trianjob-yaml.ipynb. ([#2670](https://github.com/kubeflow/trainer/pull/2670) by @Electronic-Waste)
- feat: Mutable PodSpecOverrides for suspended TrainJob ([#2683](https://github.com/kubeflow/trainer/pull/2683) by @astefanutti)
- feat(controller): Implement PodSpecOverride API ([#2614](https://github.com/kubeflow/trainer/pull/2614) by @andreyvelich)
...
- fix(manifests): Add RBAC rules for Leases in Helm Charts ([#2901](https://github.com/kubeflow/trainer/pull/2901) by @astefanutti)
- fix(docs): correct example usage in KEP-2437-Support-Volcano-Scheduler ([#2898](https://github.com/kubeflow/trainer/pull/2898) by @Doris-xm)
- fix(api): Keep mpiImplementation field a pointer ([#2897](https://github.com/kubeflow/trainer/pull/2897) by @astefanutti)
- fix(api): Fix lint errors for the config API ([#2896](https://github.com/kubeflow/trainer/pull/2896) by @astefanutti)
- fix: charts dependencies ([#2892](https://github.com/kubeflow/trainer/pull/2892) by @ls-2018)
- fix(runtimes): fix missing dependency in torchtune trainer image. ([#2887](https://github.com/kubeflow/trainer/pull/2887) by @Electronic-Waste)
- fix: Allow multiple podSpec overrides to target the same TargetJob ([#2880](https://github.com/kubeflow/trainer/pull/2880) by @kaisoz)
- fix(docs): Update the release document to push all changes ([#2865](https://github.com/kubeflow/trainer/pull/2865) by @andreyvelich)
- fix(ci): Add latest image tag only for the master branch ([#2854](https://github.com/kubeflow/trainer/pull/2854) by @andreyvelich)
- fix: read only permission for PRs ([#2829](https://github.com/kubeflow/trainer/pull/2829) by @jaiakash)
- fix: read only permission for PRs ([#2827](https://github.com/kubeflow/trainer/pull/2827) by @jaiakash)
- fix: update examples to reflect func_args now being unpacked ([#2815](https://github.com/kubeflow/trainer/pull/2815) by @briangallagher)
- fix(examples): Update get_job_logs() API in examples ([#2813](https://github.com/kubeflow/trainer/pull/2813) by @andreyvelich)
- fix: teraform for oci gpu based vm ([#2810](https://github.com/kubeflow/trainer/pull/2810) by @jaiakash)
- fix(api): Regenerate TrainJob CRD ([#2805](https://github.com/kubeflow/trainer/pull/2805) by @astefanutti)
- fix(ci): disable `Unit and Integration Test - Go` gh action in forked repos ([#2746](https://github.com/kubeflow/trainer/pull/2746) by @milinddethe15)
- fix(manifests): Add missing permissions for the RuntimeClass and LimitRange ([#2787](https://github.com/kubeflow/trainer/pull/2787) by @tenzen-y)
- fix: update kubeflow sdk reference ([#2780](https://github.com/kubeflow/trainer/pull/2780) by @kramaranya)
- fix(api): update license path for kubeflow_trainer_api ([#2778](https://github.com/kubeflow/trainer/pull/2778) by @kramaranya)
- fix(runtimes): Set numProcPerNode: 1 in DeepSpeed Runtime ([#2774](https://github.com/kubeflow/trainer/pull/2774) by @andreyvelich)
- fix(docs): update KEP-2401 according to current implementation. ([#2765](https://github.com/kubeflow/trainer/pull/2765) by @Electronic-Waste)
- fix(ci): Remove coverage from Go integration tests ([#2773](https://github.com/kubeflow/trainer/pull/2773) by @andreyvelich)
- fix(api): Fix license path for Kubeflow Trainer Python API ([#2771](https://github.com/kubeflow/trainer/pull/2771) by @andreyvelich)
- fix(examples): Update the argument for Runtime framework ([#2766](https://github.com/kubeflow/trainer/pull/2766) by @andreyvelich)
- fix(test): Fix Ginkgo command for integration tests ([#2758](https://github.com/kubeflow/trainer/pull/2758) by @astefanutti)
- fix: fix the command for fetching Kubeflow Trainer version in the issue template ([#2732](https://github.com/kubeflow/trainer/pull/2732) by @rudeigerc)
- fix(manifests): add rbac config of events for event recorders ([#2731](https://github.com/kubeflow/trainer/pull/2731) by @rudeigerc)
- fix(manifests): fix position of labels of dataset-initializer from pod to job ([#2719](https://github.com/kubeflow/trainer/pull/2719) by @rudeigerc)
- fix(module): Change Go module name to v2 ([#2707](https://github.com/kubeflow/trainer/pull/2707) by @andreyvelich)
- fix(plugins): Fix some errors in torchtune mutation process. ([#2675](https://github.com/kubeflow/trainer/pull/2675) by @Electronic-Waste)
- fix(manifests): Update manifests to enable LLM fine-tuning workflow with CTR and TrainJob yaml files ([#2669](https://github.com/kubeflow/trainer/pull/2669) by @Electronic-Waste)
- fix(rbac): Add required RBAC to update ClusterTrainingRuntimes on OpenShift ([#2682](https://github.com/kubeflow/trainer/pull/2682) by @astefanutti)
- fix(sdk): Fix bad arg passed to `get_args_using_torchtune_config` ([#2647](https://github.com/kubeflow/trainer/pull/2647) by @eoinfennessy)
- fix(sdk): Fix type annotation for `train` method's `trainer` parameter ([#2646](https://github.com/kubeflow/trainer/pull/2646) by @eoinfennessy)
- fix(controller): Fix RBAC permissions for TrainJob controller ([#2626](https://github.com/kubeflow/trainer/pull/2626) by @andreyvelich)
- fix: remove redundant K8s version matrix from integration tests ([#2617](https://github.com/kubeflow/trainer/pull/2617) by @tr33k)
...
- chore(ci): Enable Kubernetes API Linter ([#2858](https://github.com/kubeflow/trainer/pull/2858) by @astefanutti)
- chore(test): Support e2e cluster setup with Podman ([#2861](https://github.com/kubeflow/trainer/pull/2861) by @astefanutti)
- chore(runtimes): Upgrade torchtune version to v0.6.1 ([#2876](https://github.com/kubeflow/trainer/pull/2876) by @Electronic-Waste)
- chore(operator): Upgrade JobSet to v0.10.1 ([#2875](https://github.com/kubeflow/trainer/pull/2875) by @astefanutti)
- chore: Install released version of Kubeflow SDK ([#2857](https://github.com/kubeflow/trainer/pull/2857) by @kramaranya)
- chore(ci): Ignore generated files in .gitattributes ([#2855](https://github.com/kubeflow/trainer/pull/2855) by @andreyvelich)
- chore(test): add uts for coscheduling plugin. ([#2582](https://github.com/kubeflow/trainer/pull/2582) by @IRONICBo)
- chore: merge test cases using PodSpecOverrides into a single case ([#2822](https://github.com/kubeflow/trainer/pull/2822) by @toVersus)
- chore(runtimes): update torchtune CTRs with multiple dependson feature in jobset v0.9.0 ([#2823](https://github.com/kubeflow/trainer/pull/2823) by @Electronic-Waste)
- chore(operator): Bump JobSet to v0.9.0 version ([#2821](https://github.com/kubeflow/trainer/pull/2821) by @andreyvelich)
- chore: Nominate @astefanutti as Kubeflow Trainer approver ([#2808](https://github.com/kubeflow/trainer/pull/2808) by @andreyvelich)
- chore: deflake test to ensure runtime is created before creating trainjob ([#2807](https://github.com/kubeflow/trainer/pull/2807) by @toVersus)
- chore(docs): Add license scan report and status ([#2788](https://github.com/kubeflow/trainer/pull/2788) by @fossabot)
- chore(operator): Upgrade Kubernetes to v1.34 ([#2804](https://github.com/kubeflow/trainer/pull/2804) by @astefanutti)
- chore: Remove tool.hatch.build.targets.wheel from pyproject ([#2803](https://github.com/kubeflow/trainer/pull/2803) by @kramaranya)
- chore: Add unit tests for `pkg/apply` ([#2479](https://github.com/kubeflow/trainer/pull/2479) by @akagami-harsh)
- chore(runtimes): Remove MPI pi Runtime ([#2760](https://github.com/kubeflow/trainer/pull/2760) by @andreyvelich)
- chore(runtimes): Update packages in DeepSpeed runtime and fix T5 example ([#2781](https://github.com/kubeflow/trainer/pull/2781) by @andreyvelich)
- chore(docs): Add Changelog for Kubeflow Trainer v2.0.0 ([#2743](https://github.com/kubeflow/trainer/pull/2743) by @andreyvelich)
- chore: update github runners to oci gh arc runners ([#2739](https://github.com/kubeflow/trainer/pull/2739) by @koksay)
- chore(ci): Add GitHub action to verify PR titles ([#2724](https://github.com/kubeflow/trainer/pull/2724) by @andreyvelich)
- chore: Upgrade JobSet to version 0.8.2 ([#2726](https://github.com/kubeflow/trainer/pull/2726) by @astefanutti)
- chore(docs): Add Changelog for v2.0.0-rc.1 ([#2709](https://github.com/kubeflow/trainer/pull/2709) by @andreyvelich)
- chore(docs): Update Release Guide ([#2710](https://github.com/kubeflow/trainer/pull/2710) by @andreyvelich)
- chore: Copy generated CRDs into Helm charts ([#2703](https://github.com/kubeflow/trainer/pull/2703) by @astefanutti)
- chore: Replace the deprecated intstr.FromInt with intstr.FromInt32 ([#2695](https://github.com/kubeflow/trainer/pull/2695) by @tenzen-y)
- chore: Remove the vendor specific parameters ([#2691](https://github.com/kubeflow/trainer/pull/2691) by @tenzen-y)
- chore(runtime): Bump Torch to 2.7.1 and DeepSpeed to 0.17.1 ([#2685](https://github.com/kubeflow/trainer/pull/2685) by @andreyvelich)
- chore(helm): Sync ClusterRule in Helm chart ([#2686](https://github.com/kubeflow/trainer/pull/2686) by @astefanutti)
- chore(docs): Cherry-pick changelog for Training Operator v1.9.0  ([#2661](https://github.com/kubeflow/trainer/pull/2661) by @andreyvelich)
- chore(build): Support Podman to run OpenAPI generator ([#2656](https://github.com/kubeflow/trainer/pull/2656) by @astefanutti)
- chore(docs): Add OpenSSF Best Practices Badge ([#2611](https://github.com/kubeflow/trainer/pull/2611) by @andreyvelich)
- chore(deps): bump torch from 2.5.0 to 2.6.0 in /cmd/runtimes/deepspeed ([#2606](https://github.com/kubeflow/trainer/pull/2606) by @dependabot[bot])
- chore(deps): bump golang.org/x/net from 0.36.0 to 0.38.0 ([#2602](https://github.com/kubeflow/trainer/pull/2602) by @dependabot[bot])


### New Contributors
* @jaiakash made their first contribution in [#3067](https://github.com/kubeflow/trainer/pull/3067)
* @kaisoz made their first contribution in [#3151](https://github.com/kubeflow/trainer/pull/3151)
...
* @Goku2099 made their first contribution in [#3100](https://github.com/kubeflow/trainer/pull/3100)
* @khushiiagrawal made their first contribution in [#3080](https://github.com/kubeflow/trainer/pull/3080)
...
* @milinddethe15 made their first contribution in [#3077](https://github.com/kubeflow/trainer/pull/3077)
...
* @rudeigerc made their first contribution in [#2728](https://github.com/kubeflow/trainer/pull/2728)
* @kapil27 made their first contribution in [#2895](https://github.com/kubeflow/trainer/pull/2895)
* @jskswamy made their first contribution in [#2653](https://github.com/kubeflow/trainer/pull/2653)
* @Doris-xm made their first contribution in [#2898](https://github.com/kubeflow/trainer/pull/2898)
* @ls-2018 made their first contribution in [#2892](https://github.com/kubeflow/trainer/pull/2892)
* @tdn21 made their first contribution in [#2791](https://github.com/kubeflow/trainer/pull/2791)
* @xigang made their first contribution in [#2882](https://github.com/kubeflow/trainer/pull/2882)
* @kramaranya made their first contribution in [#2857](https://github.com/kubeflow/trainer/pull/2857)
* @toVersus made their first contribution in [#2822](https://github.com/kubeflow/trainer/pull/2822)
* @briangallagher made their first contribution in [#2815](https://github.com/kubeflow/trainer/pull/2815)
* @fossabot made their first contribution in [#2788](https://github.com/kubeflow/trainer/pull/2788)
* @akagami-harsh made their first contribution in [#2479](https://github.com/kubeflow/trainer/pull/2479)
* @juniemariam made their first contribution in [#2767](https://github.com/kubeflow/trainer/pull/2767)
* @Debabrata47 made their first contribution in [#2528](https://github.com/kubeflow/trainer/pull/2528)
* @kunal-511 made their first contribution in [#2759](https://github.com/kubeflow/trainer/pull/2759)
* @koksay made their first contribution in [#2739](https://github.com/kubeflow/trainer/pull/2739)
* @eoinfennessy made their first contribution in [#2657](https://github.com/kubeflow/trainer/pull/2657)
* @solanyn made their first contribution in [#2580](https://github.com/kubeflow/trainer/pull/2580)
* @vzamboulingame made their first contribution in [#2620](https://github.com/kubeflow/trainer/pull/2620)
* @tr33k made their first contribution in [#2617](https://github.com/kubeflow/trainer/pull/2617)

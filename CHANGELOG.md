...
## [v2.4.0](https://github.com/kubeflow/trainer/releases/tag/v2.4.0) (2026-02-22)

This is Kubeflow Trainer v2.4.0 release.

```bash
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/manager?ref=v2.4.0"
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/runtimes?ref=v2.4.0"
```

You can now install controller manager with Helm charts 🚀

```bash
helm install kubeflow-trainer oci://ghcr.io/kubeflow/charts/kubeflow-trainer --version 2.4.0
```
...
## [v2.3.0](https://github.com/kubeflow/trainer/releases/tag/v2.3.0) (2026-02-22)
...
- fix: remove repository condition from build-and-publish job (@milinddethe15)



## [v2.2.0](https://github.com/kubeflow/trainer/releases/tag/v2.2.0) (2026-02-22)
...
- feat: Feat/automate release ([#9](https://github.com/kubeflow/trainer/pull/9) by @milinddethe15)
...
### New Contributors
* @Goku2099 made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @puwun made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @khushiiagrawal made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
...
* @sameerdattav made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @Fiona-Waters made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @aniketpati1121 made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @yosri-brh made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @robert-bell made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @sksingh2005 made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @Sanskarzz made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @ChughShilpa made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @vsoch made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @ryanHwH20 made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @kannon92 made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)
* @adity1raut made their first contribution in [#](https://github.com/kubeflow/trainer/pull/)

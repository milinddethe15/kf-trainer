...
class IoK8sApiAutoscalingV2HorizontalPodAutoscaler(BaseModel):
    ...
    spec: IoK8sApiAutoscalingV2HorizontalPodAutoscalerSpec = Field(description="spec is the specification for the behaviour of the autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.")
